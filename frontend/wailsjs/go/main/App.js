...
export function WorkspaceAddConvertedSource(arg1) {
  return window['go']['main']['App']['WorkspaceAddConvertedSource'](arg1);
}

export function WorkspaceAddImageSource(arg1) {
